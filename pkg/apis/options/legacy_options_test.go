...
var _ = Describe("Legacy Options", func() {
	Context("ToOptions", func() {
		It("converts the options as expected", func() {
			...
			legacyOpts.LegacyProvider.InsecureOIDCAllowExpiredIDTokenOnExternalRedemption = true
			...
			opts.Providers[0].OIDCConfig.InsecureAllowExpiredIDTokenOnExternalRedemption = ptr.To(true)
